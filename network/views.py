...
class NewPostForm(forms.Form):
    ...
    post_text = forms.Field(widget=forms.Textarea(
        {'rows': '2', 'maxlength': 999, 'class': 'form-control', 'placeholder': "Type your post here"}), label="New Post", required=True)


class NewEditPostForm(forms.Form):
    # The edit post form class
    id_post_edit_text = forms.Field(widget=forms.Textarea(
        {'rows': '2', 'maxlength': 999, 'class': 'form-control', 'placeholder': "Edit your post here", 'id': 'id_post_edit_text'}), label="New Post", required=True)
