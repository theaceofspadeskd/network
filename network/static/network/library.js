document.addEventListener('DOMContentLoaded', function () {
    ...
    // id^ get ALL elements whose ID starts with 'frm_edit_'
    ...
    if (document.getElementById("btnfollow")) {
        ...
        //Displays the Unfollow text on the Following button when passing the mouse.
        ...
        //Displays the text "Following" on the Following button when removing the mouse.
    ...
    //Displays the alert message according to the return ( or error).
    function alertMessage(data, alert, id) {
        ...
        if (document.getElementById('alert_message') == null) {
            if (data.error) {
                ...
                div.innerHTML = "Post changed fully!";
                div.className = 'alert alert-dismissible fade alert- in show';
            }
        }
